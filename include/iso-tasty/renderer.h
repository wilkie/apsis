...
namespace IsoTasty {
	...
	public:
		...
		void drawTile(float x, float y, float z, float width, float height, float depth, float heights[4]);
		void drawTileTop(float x, float y, float z, float width, float height, float depth, float heights[4]);
